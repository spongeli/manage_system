<template>
	<div :width="isCollapse ? '64px' : '200px'" style="background-color: #333744;">
		<el-aside :width="isCollapse ? '64px' : '200px'" class="mall-aside">
			...
			<el-menu :default-active="activePath" background-color="#333744" :router="true" text-color="#fff" active-text-color="#409EFF" :unique-opened="true" :collapse="isCollapse" :collapse-transition="false">
				<!-- 一级菜单 -->
