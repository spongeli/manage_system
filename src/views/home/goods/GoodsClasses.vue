	...
	<div>
		...
		<el-dialog title="添加分类" :visible.sync="cateDialog.isVisible" label-width="100px" @close="closeDialog">
			...
			<el-form ref="cateFormRef" :model="cateDialog.form" :rules="cateDialog.cateFormRules" label-width="80px">
				...
				<el-form-item label="排序级别" prop="categoryOrder"><el-input v-model="cateDialog.form.categoryOrder" type="number"></el-input></el-form-item>
				<el-form-item label="分类描述" prop="categoryDesc"><el-input v-model="cateDialog.form.categoryDesc" type="textarea"></el-input></el-form-item>
			</el-form>
		...
		<el-dialog title="编辑分类" :visible.sync="editCateDialog.isVisible" label-width="100px">
			...
			<el-form ref="editCateFormRef" :model="editCateDialog.form" :rules="editCateDialog.editCateDialogRule" label-width="80px">
				<el-form-item label="分类名称" prop="categoryName"><el-input v-model="editCateDialog.form.categoryName"></el-input></el-form-item>
				<el-form-item label="父级分类">
					<el-cascader
						v-model="editCateDialog.form.categoryParentId"
						:options="cateData"
						:props="{ expandTrigger: 'hover', value: 'categoryId', label: 'categoryName', checkStrictly: true }"
						@change="handleChange"
						clearable
				...
				<el-form-item label="排序级别" prop="categoryOrder"><el-input v-model="editCateDialog.form.categoryOrder" type="number"></el-input></el-form-item>
				<el-form-item label="分类描述" prop="categoryDesc"><el-input v-model="editCateDialog.form.categoryDesc" type="textarea"></el-input></el-form-item>
			</el-form>
